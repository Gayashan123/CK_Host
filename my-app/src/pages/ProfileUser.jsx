  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-md shadow-gray-400 p-6 mb-8">
            ...
            <AnimatePresence>
              {filteredPlaces.map((place) => (
                <motion.div
                  ...
                  className="bg-gray-300 shadow-md shadow-white rounded-xl overflow-hidden  hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
